...
export const styles = {
  title: clsx("text-2xl font-semibold tracking-tight"),
  description: clsx("mt-2 text-sm text-slate-400"),
  ...
  link: clsx("font-medium text-slate-200 hover:text-slate-100 hover:underline"),
};
