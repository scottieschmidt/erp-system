/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: cae20f9e1c9d8b17af8f2efa5b347c79)
// Runtime types generated with workerd@1.20260312.1 2025-09-02 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		ASSETS: Fetcher;
		SUPABASE_URL: "https://uasshkfuiyslfhaaddrb.supabase.co";
		SUPABASE_KEY: "sb_publishable_eqD4aqQtnsAyZIzQxEDbnQ_wGV4QcLd";
		DATABASE_URL: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SUPABASE_URL" | "SUPABASE_KEY" | "DATABASE_URL">> {}
}
